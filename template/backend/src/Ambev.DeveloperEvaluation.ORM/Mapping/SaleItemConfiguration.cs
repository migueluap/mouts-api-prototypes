...
public class SaleItemConfiguration : IEntityTypeConfiguration<SaleItem>
{
    public void Configure(EntityTypeBuilder<SaleItem> builder)
    {
        ...
        // PostgreSQL: Manually generated bytea for concurrency control
        // Unlike SQL Server's rowversion, PostgreSQL bytea must be manually set
        // NOTE: Do NOT use IsRowVersion() as it prevents manual value setting
